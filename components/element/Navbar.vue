    ...
    <div w-full px="5 sm:10 md:12 lg:5" mx-auto max-w-7xl>
      <nav w-full flex justify-between gap-6 relative>
        <div min-w-max inline-flex relative>
          <nuxt-link to="/" class="relative flex items-center gap-3">
            <div class="inline-flex">
              <img src="/fav.webp" alt="GriloBet Logo" class="h-8" />
            </div>
          </nuxt-link>
        </div>
        ...
        <div
          aria-hidden="true"
          fixed
          bg="border-neutral-7/50"
          inset-0
          backdrop-filter
          backdrop-blur-xl
          class="bg-neutral-8/40"
        ...
        <div
          ...
          lg="full lg:0"
          top="full lg:0"
          border="~ neutral-2 dark:neutral-7 lg:0"
          flex-col
          lg-flex-row
          gap-y-6
          gap-x-4
          lg-justify-between
          lg-items-center
          bg="white dark:neutral-950 lg:!transparent"
          :class="
            navIsOpen
              ? 'translate-y-0 visible op-100'
              : 'translate-y-10 invisible op-0 lg-op-100 lg-visible lg-translate-y-0'
          "
        >
          <ul
            px="6 lg:0"
            ...
            gap-y-4
            gap-x-3
            text="lg neutral-7 dark:neutral-3"
            w-full
            lg-justify-center
            lg-items-center
          >
        ...
        <div min-w-max flex items-center gap-x-3>
          ...
          >
            <span
              ...
              duration-300
              ease-linear
              :class="navIsOpen ? 'translate-y-1.5 rotate-40' : ''"
            ></span>
            <span
              bg="neutral-7 dark:neutral-3"
              w6
              origin-center
              mt1
              h0.5
              ...
              duration-300
              ease-linear
              :class="navIsOpen ? 'op-0 scale-x-0' : ''"
            ></span>
            <span
              bg="neutral-7 dark:neutral-3"
              w6
